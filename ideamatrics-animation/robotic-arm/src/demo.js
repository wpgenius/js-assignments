...
async function setupViewer(){
  ...
  function setupScrollanimation(){
      ...
      tl
  .to(position, {
      x: -0.58, y: -0.62, z: 0.29,  // Keep z constant to avoid zoom
      scrollTrigger: {
          trigger: ".second",
          start: "top bottom",
          end: "top top", 
      ...
      onUpdate,
      onStart: () => adjustFOV(20),  // Optionally adjust FOV for a consistent view
      onComplete: () => adjustFOV(20),  // Keep the FOV consistent
  })
  .to(target, {
      x: -0.08, y: -0.53, z: 0.011,  // Adjust target to rotate around the model
      scrollTrigger: {
          trigger: ".second",
          start: "top bottom",
          end: "top top", 
  ...
  .to(position, {
      x: 0.78, y: -0.75, z: 0.29,  // Keep z constant again
      scrollTrigger: {
          trigger: ".third",
          start: "top bottom",
          end: "top top", 
      ...
      onUpdate,
      onStart: () => adjustFOV(20),  // Consistent FOV
      onComplete: () => adjustFOV(20),  // Consistent FOV
  })
  .to(target, {
      x: -0.010, y: -0.808, z: 0.165,  // Adjust target for rotation
      scrollTrigger: {
          trigger: ".third",
          start: "top bottom",
          end: "top top", 
